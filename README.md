<div align="center">
  ...
  <p>Versão atual: <code>2.1.0-test.13</code> · Estágio: teste multiplataforma</p>
</div>

[![Versão](https://img.shields.io/badge/versão-2.1.0--test.13-1597c5)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.13)
[![Ubuntu](https://img.shields.io/badge/Ubuntu-22.04%20%7C%2024.04%20%7C%2026.04-E95420?logo=ubuntu&logoColor=white)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.13)
[![Windows](https://img.shields.io/badge/Windows-x64-0078D4?logo=windows&logoColor=white)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.13)
[![Testes](https://img.shields.io/badge/testes-269%20aprovados-2ea44f)](docs/releases/v2.1.0-test.13.md)

**[Baixar a versão test.13](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.13)**
...
### Novidades da test.13

- informe financeiro e modelo fiscal separados, sem inferir IRRF do extrato;
- cadastro validado por ano e fonte pagadora com os quadros fiscais 1 a 7;
- PDF com quebra de linhas e controles responsivos na tela de relatórios;
- traduções offline das novas ações em inglês e espanhol;
- paginação sem sobreposição e tabelas com espaço útil em faturas e contas;
- próximas faturas limitadas às competências realmente posteriores;
- agendamentos responsivos, com mês selecionado destacado e colunas legíveis;
- histórico de faturas pagas sempre visível, sem compressão da tabela;
- planejamento mensal com mês atual e três posteriores, atualizado no clique;
- totais de agendamentos recalculados para o mês selecionado;
- interface mais compacta, com botões circulares, animações e dicas;
- ciclo real de faturas abertas, fechadas e pagas;
- pagamento registrado somente em `pagamentos_fatura`, sem duplicação;
- backup obrigatório e validado antes da migração corretiva;
- créditos, estornos e ajustes preservados com seu sinal financeiro;
- vencimento correto em viradas de mês/ano e parcelamento sem perda de centavos;
- vínculo por `ID_Fatura` validado por triggers em bancos novos e migrados;
...
| Versão da aplicação | `2.1.0-test.13` |
| Versão do pacote Debian | `2.1.0~test13` |
...
[`docs/releases/v2.1.0-test.13.md`](docs/releases/v2.1.0-test.13.md). O relatório
...
- [Instalador Linux DEB](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_amd64.deb)
- [Checksum Linux](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_amd64.deb.sha256)
- [Pacote Windows ZIP](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_windows-x64.zip)
- [Checksum Windows](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_windows-x64.zip.sha256)
...
[Release v2.1.0-test.13](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.13).

Confira a integridade do arquivo:

```bash
sha256sum -c finance-assist_2.1.0-test.13_amd64.deb.sha256
```
...
- [DEB Ubuntu 24.04 / Mint 22.x](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_ubuntu24.04_amd64.deb)
- [SHA256 da variante](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.13/finance-assist_2.1.0-test.13_ubuntu24.04_amd64.deb.sha256)

```bash
sha256sum -c finance-assist_2.1.0-test.13_ubuntu24.04_amd64.deb.sha256
sudo apt install ./finance-assist_2.1.0-test.13_ubuntu24.04_amd64.deb
finance-assist-test
```
...
`2.1.0~test13+ubuntu24.04.1`, com dependências Noble (`libglib2.0-0t64` e
...
Baixe `finance-assist_2.1.0-test.13_windows-x64.zip`, verifique o arquivo
...
```powershell
Get-FileHash .\finance-assist_2.1.0-test.13_windows-x64.zip -Algorithm SHA256
```
