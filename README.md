<div align="center">
  ...
  <p>Versão atual: <code>2.1.0-test.6</code> · Estágio: teste multiplataforma</p>
</div>
...
| Versão da aplicação | `2.1.0-test.6` |
| Versão do pacote Debian | `2.1.0~test6` |
...
[`docs/releases/v2.1.0-test.6.md`](docs/releases/v2.1.0-test.6.md). O relatório
...
- [Instalador Linux DEB](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_amd64.deb)
- [Checksum Linux](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_amd64.deb.sha256)
- [Pacote Windows ZIP](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_windows-x64.zip)
- [Checksum Windows](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_windows-x64.zip.sha256)
...
[Release v2.1.0-test.6](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.6).

Confira a integridade do arquivo:

```bash
sha256sum -c finance-assist_2.1.0-test.6_amd64.deb.sha256
```

Instale o pacote:

```bash
sudo apt install ./finance-assist_2.1.0-test.6_amd64.deb
```
...
- [DEB Ubuntu 24.04 / Mint 22.x](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_ubuntu24.04_amd64.deb)
- [SHA256 da variante](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.6/finance-assist_2.1.0-test.6_ubuntu24.04_amd64.deb.sha256)

```bash
sha256sum -c finance-assist_2.1.0-test.6_ubuntu24.04_amd64.deb.sha256
sudo apt install ./finance-assist_2.1.0-test.6_ubuntu24.04_amd64.deb
finance-assist-test
```
...
`2.1.0~test6+ubuntu24.04.1`, com dependências Noble (`libglib2.0-0t64` e
...
Baixe `finance-assist_2.1.0-test.6_windows-x64.zip`, verifique o arquivo
...
```powershell
Get-FileHash .\finance-assist_2.1.0-test.6_windows-x64.zip -Algorithm SHA256
```
