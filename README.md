<div align="center">
  ...
  <p>Versão atual: <code>2.1.0-test.11</code> · Estágio: teste multiplataforma</p>
</div>

[![Versão](https://img.shields.io/badge/versão-2.1.0--test.11-1597c5)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.11)
[![Ubuntu](https://img.shields.io/badge/Ubuntu-22.04%20%7C%2024.04%20%7C%2026.04-E95420?logo=ubuntu&logoColor=white)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.11)
[![Windows](https://img.shields.io/badge/Windows-x64-0078D4?logo=windows&logoColor=white)](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.11)
[![Testes](https://img.shields.io/badge/testes-265%20aprovados-2ea44f)](docs/releases/v2.1.0-test.11.md)

**[Baixar a versão test.11](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.11)**
...
| Versão da aplicação | `2.1.0-test.11` |
| Versão do pacote Debian | `2.1.0~test11` |
...
[`docs/releases/v2.1.0-test.11.md`](docs/releases/v2.1.0-test.11.md). O relatório
...
- [Instalador Linux DEB](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_amd64.deb)
- [Checksum Linux](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_amd64.deb.sha256)
- [Pacote Windows ZIP](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_windows-x64.zip)
- [Checksum Windows](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_windows-x64.zip.sha256)
...
[Release v2.1.0-test.11](https://github.com/boente66/Finance_Assist/releases/tag/v2.1.0-test.11).

Confira a integridade do arquivo:

```bash
sha256sum -c finance-assist_2.1.0-test.11_amd64.deb.sha256
```
...
- [DEB Ubuntu 24.04 / Mint 22.x](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_ubuntu24.04_amd64.deb)
- [SHA256 da variante](https://github.com/boente66/Finance_Assist/releases/download/v2.1.0-test.11/finance-assist_2.1.0-test.11_ubuntu24.04_amd64.deb.sha256)

```bash
sha256sum -c finance-assist_2.1.0-test.11_ubuntu24.04_amd64.deb.sha256
sudo apt install ./finance-assist_2.1.0-test.11_ubuntu24.04_amd64.deb
finance-assist-test
```
...
`2.1.0~test11+ubuntu24.04.1`, com dependências Noble (`libglib2.0-0t64` e
...
Baixe `finance-assist_2.1.0-test.11_windows-x64.zip`, verifique o arquivo
...
```powershell
Get-FileHash .\finance-assist_2.1.0-test.11_windows-x64.zip -Algorithm SHA256
```
